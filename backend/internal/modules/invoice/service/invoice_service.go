...
func (s *invoiceService) GetAll(ctx context.Context) ([]dto.InvoiceResponse, error) {
...
func (s *invoiceService) GetByOrderID(ctx context.Context, orderID string) (*dto.InvoiceResponse, error) {
	if orderID == "" {
